<?php /* Smarty version 2.6.26, created on 2011-05-15 11:49:41
         compiled from music_add.html */ ?>
        ...
        <div  id="main_content">    <!--main_left start-->
           ...
           <div  class="content_block   emotion_publish">
               ...
               <div  class="info_main">
                   ...
                   <img src="<?php echo $this->_tpl_vars['temp_dir']; ?>
/images/user_music.gif" width="16" height="17" /> <b href="javascript:void(0);"  class="info_now"  style="font-size:12px;"><?php echo $this->_tpl_vars['tool_title']; ?>
</b>
                   <div class="clear"></div>
                   </div>
                   ...
                   <div  id="info_content">
                   <form action="index.php?display=music_add" enctype="multipart/form-data"   method="post"  name="music_add_form">


                   <INPUT TYPE=hidden NAME=display  VALUE="music_add">
...
">
                   <INPUT TYPE=hidden NAME=unlink_file_path  VALUE="<?php echo $this->_tpl_vars['path']; ?>
">

                   <span  class="info_span"><b>歌曲名称</b>
                        <p>
...
"  class="text_input"   onfocus="this.className='text_input   text_input_hover'"  onblur="this.className='text_input'"/>
                   ...
                   <span  class="info_span"><b>歌曲演唱</b>
                   <p><input name="singer" type="text"  value="<?php echo $this->_tpl_vars['singer']; ?>
"   class="text_input"   onfocus="this.className='text_input   text_input_hover'"  onblur="this.className='text_input'"/></p>
                   </span>

                   <span  class="info_span"><b>歌曲作词</b>
                         <p><input name="lyric" type="text" value="<?php echo $this->_tpl_vars['lyric']; ?>
"    class="text_input"   onfocus="this.className='text_input   text_input_hover'"  onblur="this.className='text_input'"/></p>
                   </span>

                   <span   class="info_span"><b>歌曲地址</b>
                        <p>
                            ...
                            <input type="radio" name="path_select" value="self_upload" class="input_radio"/   onclick="music_input_upload()"><font><strong>上传音乐</strong></font>
                        </p>
...
"   class="text_input"   onClick="getDateString(this,oCalendarChs)"   onfocus="this.className='text_input   text_input_hover'"  onblur="this.className='text_input'" /><font>(请输入网络音乐地址<i  style="color:#ff3300">*仅支持.mp3</i>)</font></p>
                   </span>

                   <span  class="info_span"  id="music_upload">
                         <b></b>
                         <p>
		                 <input type="file" name="local_path"   style="*margin-left:-40px;"/><font>(<i style="color:#ff3300">仅支持:.mp3</i>)</font>
                         </p>
                   </span>


                   <span   class="info_span"><b>喜爱级别</b>
                        <p>
...
/images/love_grade.jpg" width="12" height="12" />
                   ...
                   <span   class="info_span"><b>音乐描述</b>
                         <p>
                          <textarea     name="description"  onfocus="this.style.border='#21759B  solid  1px'"  onblur="this.style.border='#A5ACB2  solid  1px'"   style="*margin-left:-40px;"><?php echo $this->_tpl_vars['description']; ?>
</textarea>
                         </p>
                   </span>
                   ...
                   <span   class="info_span"><b></b>
                        <p><b  onclick="document.music_add_form.submit()"><?php echo $this->_tpl_vars['tool_submit']; ?>
</b></p>
                   </span>
