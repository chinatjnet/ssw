<?php /* Smarty version 2.6.26, created on 2011-03-20 15:54:11
         compiled from contact_info.html */ ?>
           ...
           <div  class="content_block   emotion_publish">
               ...
               <div  class="info_main">
                   ...
                   <span  class="info_span"><b>MSN账号</b>
                         <p><input name="" type="text"   class="text_input"    onfocus="this.style.border='#21759B  solid  1px'"  onblur="this.style.border='#A5ACB2  solid  1px'" /><font>(格式：2011-03-07)</font></p>
                         <select name="jumpMenu2" >
                             <option value="?id=11" selected="selected" >所有可见</option>
                             <option value="?id=11" >好友可见</option>
                             <option value="?id=11" >情侣可见</option>
