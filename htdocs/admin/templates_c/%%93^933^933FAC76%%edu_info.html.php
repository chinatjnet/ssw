<?php /* Smarty version 2.6.26, created on 2011-03-20 15:56:15
         compiled from edu_info.html */ ?>
           ...
           <div  class="content_block   emotion_publish">
               ...
               <div  class="info_main">
                   ...
                   <span  class="info_span"><b>学历</b>
                         <p><select name="jumpMenu2">
                             <option value="?id=11" selected="selected" >小学</option>
                             <option value="?id=11" >高中</option>
                             <option value="?id=11" >专科</option>
                             <option value="?id=11" >本科</option>
                             <option value="?id=11" >硕士</option>
                             <option value="?id=2">博士</option>
                             <option value="?id=2">其它</option>
                         </select>
                         </p>
                   ...
                   <p><input name="" type="text"   class="text_input"   onfocus="this.style.border='#21759B  solid  1px'"  onblur="this.style.border='#A5ACB2  solid  1px'"/></p>
                         <select name="jumpMenu2">
                             <option value="?id=11" selected="selected" >所有可见</option>
                             <option value="?id=11" >好友可见</option>
                             <option value="?id=11" >情侣可见</option>
