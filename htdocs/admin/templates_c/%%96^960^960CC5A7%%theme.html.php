<?php /* Smarty version 2.6.26, created on 2011-06-03 12:56:27
         compiled from theme.html */ ?>
...
/images/theme_center.png" width="31" height="34"   class="control_logo"/>
           <h1>模板选择</h1>
           <div id="news">
                   <img src="<?php echo $this->_tpl_vars['temp_dir']; ?>
...
/images/user_system.gif" width="16" height="17" /> <b href="javascript:void(0);"  class="info_now">模板选择</b>
                   ...
                   <span  class="info_span"> <img src="<?php echo $this->_tpl_vars['theme_present_view']; ?>
" width="150" height="150" style="padding:6px;border:#cfcfcf 1px solid;margin-right:15px;"/><strong><?php echo $this->_tpl_vars['theme_present']; ?>
</strong></span>
...
" width="150" height="150" /><br>
                         ...
                         <a  href="index.php?display=theme&do=theme_on&theme=<?php echo $this->_tpl_vars['theme'][$this->_sections['theme']['index']]['name']; ?>
">启用</a>&nbsp;&nbsp;&nbsp;
                         <a  href="index.php?display=theme&do=theme_view&theme=<?php echo $this->_tpl_vars['theme'][$this->_sections['theme']['index']]['name']; ?>
">预览</a>
                      </li>
