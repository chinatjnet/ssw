...
//开始分页导航条代码：
if ($showtext==1){
$pagenav="<span class='disabled'>共".$totle."条</span>";
}else{
$pagenav="";
}
//如果只有一页则跳出函数：
...
if($prepg) $pagenav.="<a href='$url=1'><<</a>"; else $pagenav.='<span class="disabled"><<</span>';
...
if($nextpg) $pagenav.="<a href='$url=$lastpg'>>></a>"; else $pagenav.='<span class="disabled">>></span>';
if ($showselect==1){
//下拉跳转列表，循环列出所有页码：
$pagenav.="跳至<select name='topage' size='1' onchange='if(this.selectedIndex>-1)location.href=\"$url=\"+this.options[this.selectedIndex].value'>\n";
for($i=1;$i<=$lastpg;$i++){
